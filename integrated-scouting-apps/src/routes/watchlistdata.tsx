...
//         custom8 = customArr[8];
//         custom9 = customArr[9];
//         custom10 = customArr[10];
//         custom11 = customArr[11];
//         custom12 = customArr[12];
//         custom13 = customArr[13];
//         custom14 = customArr[14];
//         custom15 = customArr[15];
//         custom16 = customArr[16];
//         custom17 = customArr[17];
//         custom18 = customArr[18];
//         custom19 = customArr[19];
//         custom20 = customArr[20];
//         arrQ.push(custom0.question as string, custom1.question as string, custom2.question as string, custom3.question as string, 
//                   custom4.question as string, custom5.question as string, custom6.question as string, custom7.question as string, 
//                   custom8.question as string, custom9.question as string, custom10.question as string, custom11.question as string,
//                   custom12.question as string, custom13.question as string, custom14.question as string, custom15.question as string, 
//                   custom16.question as string, custom17.question as string, custom18.question as string, custom19.question as string, 
//                   custom20.question as string)
//         arrT.push(custom0.question_type as string, custom1.question_type as string, custom2.question_type as string, custom3.question_type as string, 
//                   custom4.question_type as string, custom5.question_type as string, custom6.question_type as string, custom7.question_type as string, 
//                   custom8.question_type as string, custom9.question_type as string, custom10.question_type as string, custom11.question_type as string,
//                   custom12.question_type as string, custom13.question_type as string, custom14.question_type as string, custom15.question_type as string, 
//                   custom16.question_type as string, custom17.question_type as string, custom18.question_type as string, custom19.question_type as string, 
//                   custom20.question_type as string)
//         console.log(arrQ[0])
//         console.log(arrT[0])
//         return [team_number, data];
//       }
...
//             </td>
//             <td>
//               <h1 className='h2' style={{display: 'inline-block', textAlign: 'center'}}>Team {team_number}</h1>
//             </td>
//           </table>
//         </header>
//       </div>
